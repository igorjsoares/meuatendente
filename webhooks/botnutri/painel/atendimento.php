                ...
                <div>
                    ...
                    <div class="direct-chat-messages" style="height: 400px; background-color: #E5DDD5;">
                        ...
                        <div class="direct-chat-msg" style="padding-right: 10%;">
                            <div class="direct-chat-text" style="margin-left: 0px; margin-right: 0px; width: 100%;ackground-color: #FFF;">
                        ...
                        <div class="direct-chat-msg right"  style="padding-left: 10%;">
                            <!-- /.direct-chat-img -->
                            <div class="direct-chat-text" style="margin-left: 0px; margin-right: 0px; width: 100%; ackground-color: #DBF7C6;">
