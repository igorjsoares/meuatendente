    ...
    class whatsAppBot
    {
        ...
        public function opcao3($remoteJID, $noWelcome = false)
        {
            ...
            if ($resultado == '1') {
                ...
                $this->logSis('ERR', 'Aceitou Formula. Número: ' . $remoteJID . ' SQL: ' . $sql . ' Erro: ' . $resultado . mysqli_error($conn['link']));
            }
        }
        ...
        public function sendRequest($motivo, $method, $data)
        {
            ...
            $this->logSis('ERR', 'Resp Requisição: ' . $response);
            ...
            if ($statusEnvio == "Mensagem enviada com sucesso" || $statusEnvio == "Mensagem Enviada") {
                ...
                if ($resultado != '1') {
                    ...
                    $this->logSis('ERR', 'Insert interação IN. ID_Interação: ' . $idInteracaoIn);
                }
            } else {
